# 👋🧩 Arun's Morphe Patches

A collection of Morphe Patches for apps I like.

## ❓ About

This repository contains custom [Morphe](https://github.com/MorpheApp) patches.
...
Click here to add these patches to Morphe: https://morphe.software/add-source?github=arunpdl/morphe-patches

Or manually add this repository url as a patch source in Morphe: https://github.com/arunpdl/morphe-patches

### 📙 Contributing

Thank you for considering contributing to Arun's Morphe Patches.  
You can find the contribution guidelines [here](CONTRIBUTING.md).

### 🛠️ Building

To build Arun's Morphe Patches,
you can follow the [Morphe documentation](https://github.com/MorpheApp/morphe-documentation).

## 📜 License

Arun's Morphe Patches are licensed under the [GNU General Public License v3.0](LICENSE)
